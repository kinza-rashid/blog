...
<Footer className="bg-neutral-primary-soft rounded-none text-white bottom-0">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        Bytech
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-heading uppercase">About us</h2>
                  <ul className="text-body font-medium">
                      <li className="mb-4">
                          <a href="https://flowbite.com/" className="hover:underline">Learn JS</a>
                      </li>
                      <li>
                          <a href="https://tailwindcss.com/" className="hover:underline">100 JS Lessons</a>
                      </li>
                  </ul>
              </div>
              <div>
